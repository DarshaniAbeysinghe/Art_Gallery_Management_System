...
public class TicketChartController {

    @FXML
    private BarChart<String, Number> ticketBarChart;
    ...
    private void filterByWeek(String selectedWeek) {
        ...
        switch (selectedWeek) {
            case "This Week":
                ...
                startOfWeek = today.minusDays(today.getDayOfWeek().getValue() % 7); // Get Sunday of this week
    ...
    private void loadChartData(LocalDate startDate, LocalDate endDate) {
        String query = "SELECT DATE(IssueDate) AS issue_date, COUNT(TID) AS ticket_count " +
                "FROM tickets " +
        ...
        try (Connection connection = dbConnection.getConnection();
            ...
            while (resultSet.next()) {
                ...
                series.getData().add(new XYChart.Data<>(date, ticketCount));
